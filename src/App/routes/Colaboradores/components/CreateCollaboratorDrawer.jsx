...
/* ── Drawer ──────────────────────────────────────────────── */
export function CreateCollaboratorDrawer({ open, onClose, onSuccess }) {
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    const res = await createColaboradorService(body);
    ...
    if (res.status) {
      ...
      toast.error(res.errors ?? 'No se pudo crear el colaborador.');
    }
  });
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <SheetDescription className="text-xs mt-0.5">
                Nombre, cédula y celular son obligatorios.
              </SheetDescription>
            </div>
          </div>
        </SheetHeader>
