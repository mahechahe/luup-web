...
// ── Mini stat para la vista colapsada ─────────────────────────────────────────
...
export function ZoneCard({
  ...
  // En móvil las zonas empiezan colapsadas
  ...
  // Calcular stats para la vista colapsada
  ...
  return (
    <div className="bg-white rounded-2xl border border-border shadow-sm overflow-hidden flex flex-col">
      ...
      {/* ── Header — siempre visible, clickable en móvil ── */}
      <div
        className="px-4 sm:px-6 pt-4 sm:pt-5 pb-3 sm:pb-4 cursor-pointer sm:cursor-default"
      ...
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div className="sm:hidden flex items-center justify-center w-7 h-7 rounded-lg bg-muted/50">
              <ChevronDown
      ...
      {/* ── Vista colapsada (solo móvil) — stats rápidos ── */}
      <div
        className={`sm:hidden overflow-hidden transition-all duration-300 ${
          expanded ? 'max-h-0 opacity-0' : 'max-h-40 opacity-100'
        }`}
      >
        <div className="mx-4 border-t border-border mb-3" />
        <div className="px-4 pb-4">
          <div className="grid grid-cols-4 gap-2 bg-muted/30 rounded-2xl px-3 py-3">
            <MiniStat
              emoji="👥"
              value={staffCount}
              label="Capacidad"
      ...
      {/* En desktop siempre visible, en móvil controlado por expanded */}
      <div
